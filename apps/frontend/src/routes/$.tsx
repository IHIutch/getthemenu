import { notFound, useLoaderData, useParams } from '@tanstack/react-router'
import { createServerFn } from '@tanstack/react-start'
import { prisma } from "@repo/db"
import { getTenant } from './__root'
                        ...
                        {s.menuItems.map(menuItem => (
                            <div key={menuItem.id} className="rounded-lg border bg-white shadow overflow-hidden">
                                ...
                                <div className='p-4 flex'>
                                    ...
                                    <div>
                                        <p className="font-medium">{menuItem.price?.toLocaleString('en-US', {
                                            style: 'currency',
                                            currency: 'USD'
                                        })}</p>
                                    </div>
