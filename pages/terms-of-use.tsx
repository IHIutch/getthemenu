      ...
      <Container w="full" maxW="container.md" my="12">
        ...
        <Box>
          ...
          <Box as="ul" gap="2" listStyle="none" m="0">
            <Box as="li">
              <Link textDecoration="underline" href="#1-agreement-to-terms">
            ...
            <Box as="li">
              <Link
                ...
                href="#2-intellectual-property-rights"
              >
                2. Intellectual Property Rights
              </Link>
            </Box>
            <Box as="li">
              <Link textDecoration="underline" href="#3-user-representations">
                3. User Representations
              </Link>
            </Box>
            <Box as="li">
              <Link textDecoration="underline" href="#4-user-registration">
                4. User Registration
              </Link>
            </Box>
            <Box as="li">
              <Link textDecoration="underline" href="#5-fees-and-payment">
                5. Fees And Payment
              </Link>
            </Box>
            <Box as="li">
              <Link textDecoration="underline" href="#6-free-trial">
                6. Free Trial
              </Link>
            </Box>
            <Box as="li">
              <Link textDecoration="underline" href="#7-cancellation">
                7. Cancellation
              </Link>
            </Box>
            <Box as="li">
              <Link textDecoration="underline" href="#8-prohibited-activities">
            ...
            <Box as="li">
              <Link
                textDecoration="underline"
                href="#9-user-generated-contributions"
              >
                9. User Generated Contributions
              </Link>
            </Box>
            <Box as="li">
              <Link textDecoration="underline" href="#10-contribution-license">
                10. Contribution License
              </Link>
            </Box>
            <Box as="li">
              <Link textDecoration="underline" href="#11-social-media">
                11. Social Media
              </Link>
            </Box>
            <Box as="li">
              <Link textDecoration="underline" href="#12-submissions">
                12. Submissions
              </Link>
            </Box>
            <Box as="li">
              <Link textDecoration="underline" href="#13-us-government-rights">
                13. U.S. Government Rights
              </Link>
            </Box>
            <Box as="li">
              <Link textDecoration="underline" href="#14-site-management">
                14. Site Management
              </Link>
            </Box>
            <Box as="li">
              <Link textDecoration="underline" href="#15-privacy-policy">
                15. Privacy Policy
              </Link>
            </Box>
            <Box as="li">
              <Link textDecoration="underline" href="#16-term-and-termination">
            ...
            <Box as="li">
              <Link
                textDecoration="underline"
                href="#17-modifications-and-interruptions"
              >
                17. Modifications And Interruptions
              </Link>
            </Box>
            <Box as="li">
              <Link textDecoration="underline" href="#18-governing-law">
                18. Governing Law
              </Link>
            </Box>
            <Box as="li">
              <Link textDecoration="underline" href="#19-dispute-resolution">
                19. Dispute Resolution
              </Link>
            </Box>
            <Box as="li">
              <Link textDecoration="underline" href="#20-corrections">
                20. Corrections
              </Link>
            </Box>
            <Box as="li">
              <Link textDecoration="underline" href="#21-disclaimer">
                21. Disclaimer
              </Link>
            </Box>
            <Box as="li">
              <Link
                textDecoration="underline"
                href="#22-limitations-of-liability"
              >
                22. Limitations Of Liability
              </Link>
            </Box>
            <Box as="li">
              <Link textDecoration="underline" href="#23-indemnification">
                23. Indemnification
              </Link>
            </Box>
            <Box as="li">
              <Link textDecoration="underline" href="#24-user-data">
                24. User Data
              </Link>
            </Box>
            <Box as="li">
              <Link
                textDecoration="underline"
                href="#25-electronic-communications-transactions-and-signatures"
              >
            ...
            <Box as="li">
              <Link
                textDecoration="underline"
                href="#26-california-users-and-residents"
              >
                26. California Users And Residents
              </Link>
            </Box>
            <Box as="li">
              <Link textDecoration="underline" href="#27-miscellaneous">
                27. Miscellaneous
              </Link>
            </Box>
            <Box as="li">
              <Link textDecoration="underline" href="#28-contact-us">
                28. Contact Us
              </Link>
            </Box>
          </Box>
        ...
        <Prose>
          <Box>
            <Heading as="h2" id="1-agreement-to-terms">
              1. Agreement To Terms
            </Heading>
            <Text>
              ...
              &quot;) and GetTheMenu, LLC, doing business as GetTheMenu (&quot;
              <Text as="span" fontWeight="semibold">
                GetTheMenu
              </Text>
              &quot;, &quot;
              ...
              registered in New York, United States and have our registered
              office at 412 Bird Ave, Buffalo, NY 14213. You agree that by
              ...
              Terms of Use are posted. The information provided on the Site is
          ...
          <Box>
            <Heading as="h2" id="2-intellectual-property-rights">
              2. Intellectual Property Rights
            </Heading>
            <Text>
              ...
              written permission Provided that you are eligible to use the Site,
          ...
          <Box>
            <Heading as="h2" id="3-user-representations">
              3. User Representations
            </Heading>
            <Text>
          ...
          <Box>
            <Heading as="h2" id="4-user-registration">
              4. User Registration
            </Heading>
            <Text>
          ...
          <Box>
            <Heading as="h2" id="5-fees-and-payment">
              5. Fees And Payment
            </Heading>
            <Text>
              ...
              <Box as="ul">
                <Box as="li">Visa</Box>
                <Box as="li">Mastercard</Box>
                <Box as="li">American Express</Box>
                <Box as="li">Discover</Box>
                <Box as="li">PayPal</Box>
              </Box>
              ...
              prices at any time. All payments shall be in U.S. dollars. You
              ...
              notify us of your cancellation. We reserve the right to correct
          ...
          <Box>
            <Heading as="h2" id="7-cancellation">
              7. Cancellation
            </Heading>
            <Text>
          ...
          <Box>
            <Heading as="h2" id="8-prohibited-activities">
              8. Prohibited Activities
            </Heading>
            <Text>
              ...
              <Box as="ul">
                ...
                <Box>Sell or otherwise transfer your profile.</Box>
              </Box>
            </Text>
          </Box>
          <Box>
            <Heading as="h2" id="9-user-generated-contributions">
              9. User Generated Contributions
            </Heading>
            <Text>
          ...
          <Box>
            <Heading as="h2" id="10-contribution-license">
              10. Contribution License
            </Heading>
            <Text>
          ...
          <Box>
            <Heading as="h2" id="11-social-media">
              11. Social Media
            </Heading>
            <Text>
          ...
          <Box>
            <Heading as="h2" id="12-submissions">
              12. Submissions
            </Heading>
            <Text>
          ...
          <Box>
            <Heading as="h2" id="13-us-government-rights">
              13. U.S. Government Rights
            </Heading>
            <Text>
              Our services are &quot;commercial items&quot; as defined in
              Federal Acquisition Regulation (&quot;FAR&quot;) 2.101. If our
              services are acquired by or on behalf of any agency not within the
              Department of Defense (&quot;DOD&quot;), our services are subject
              to the terms of these Terms of Use in accordance with FAR 12.212
              ...
              these Terms of Use in accordance with Defense Federal Acquisition
              Regulation (&quot;DFARS&quot;) 227.7202-3. In addition, DFARS
          ...
          <Box>
            <Heading as="h2" id="14-site-management">
              14. Site Management
            </Heading>
            <Text>
          ...
          <Box>
            <Heading as="h2" id="15-privacy-policy">
              15. Privacy Policy
            </Heading>
            <Text>
          ...
          <Box>
            <Heading as="h2" id="16-term-and-termination">
              16. Term And Termination
            </Heading>
            <Text>
          ...
          <Box>
            <Heading as="h2" id="17-modifications-and-interruptions">
              17. Modifications And Interruptions
            </Heading>
            <Text>
          ...
          <Box>
            <Heading as="h2" id="18-governing-law">
              18. Governing Law
            </Heading>
            <Text>
          ...
          <Box>
            <Heading as="h2" id="19-dispute-resolution">
              19. Dispute Resolution
            </Heading>
            <Heading as="h3">Informal Negotiations</Heading>
            <Text>
            ...
            <Heading as="h3">Binding Arbitration</Heading>
            <Text>
              ...
              of arbitrator compensation shall be governed by the AAA Consumer
              ...
              law, the arbitration will take place in Erie, New York. Except as
              ...
              prosecuted in the state and federal courts located in Erie, New
              York, and the Parties hereby consent to, and waive all defenses of
              ...
              of Use. In no event shall any Dispute brought by either Party
            ...
            <Heading as="h3">Restrictions</Heading>
            <Text>
          ...
          <Box>
            <Heading as="h2" id="20-corrections">
              20. Corrections
            </Heading>
            <Text>
          ...
          <Box>
            <Heading as="h2" id="21-disclaimer">
              21. Disclaimer
            </Heading>
            <Text>
          ...
          <Box>
            <Heading as="h2" id="22-limitations-of-liability">
              22. Limitations Of Liability
            </Heading>
            <Text>
          ...
          <Box>
            <Heading as="h2" id="23-indemnification">
              23. Indemnification
            </Heading>
            <Text>
          ...
          <Box>
            <Heading as="h2" id="26-california-users-and-residents">
              26. California Users And Residents
            </Heading>
            <Text>
          ...
          <Box>
            <Heading as="h2" id="27-miscellaneous">
              27. Miscellaneous
            </Heading>
            <Text>
          ...
          <Box>
            <Heading as="h2" id="28-contact-us">
              28. Contact Us
            </Heading>
            <Text>
