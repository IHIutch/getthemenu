...
export default function PrivacyPolicy() {
  return (
    <Container w="full" maxW="container.md" my="12">
      ...
      <Box mb="12">
        <Text mb="4">
          This privacy notice for GetTheMenu, LLC (doing business as GetTheMenu)
          (&quot;
          <Text as="span" fontWeight="semibold">
            GetTheMenu
          </Text>
      ...
      <Box mb="12">
        <VStack as="dl" spacing="6" mb="8" alignItems="flex-start">
          <Box>
            ...
            <dd>
              ...
              personal information depending on how you interact with GetTheMenu
        ...
        <Text>
          Want to learn more about what GetTheMenu does with any information we
        ...
        <Prose>
              ...
              <VStack as="dl" spacing="6" mb="8" alignItems="flex-start">
                ...
                <Box>
                  ...
                  <dd>
                    ...
                    Paddle. You may find their privacy notice link(s) here:{' '}
                    <Link
          ...
          <Box>
            ...
            <Box>
              ...
              <Text>
                ...
                requirements. If you have questions or comments about your
          ...
          <Box>
            ...
            <Text>
              ...
              us at <Link href="mailto:info@getthemenu">info@getthemenu</Link>.
            </Text>
          </Box>
        </Prose>
      </Box>
